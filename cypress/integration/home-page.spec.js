  ...
  beforeEach(() => {
    ...
    describe("Filtering", () => {
        describe("By movie title" ,() => {
          ...
          it("exceptional: should not display any movies as no movies with 'xyz' in the title", () => {
        ...
        describe("By movie title and genre", () => {
            it("should display movies with 'a' in the title and the specified genre only", () => {
